...
if __name__ == "__main__":
    ...
    fig.write_image("generated_data.png")
    fig.write_html("generated_data.html")
    ...
    fig.write_image("generated_data_train_test.png")
    fig.write_html("generated_data_train_test.html")
    ...
    fig.write_image("generated_rel_diff_train_test.png")
    fig.write_html("generated_rel_diff_train_test.html")
    ...
    fig.write_image("generated_volume_train_test.png")
    fig.write_html("generated_volume_train_test.html")
    ...
    def apply_lstm(train_data, test_data, look_back=10, epochs=epochs, lr=0.001):
    ...
    fig.write_image("time_series_prediction.png")
    fig.write_html("time_series_prediction.html")
